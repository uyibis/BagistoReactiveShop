...
<head>
    ...
    <link
        rel="stylesheet"
        href="{{ asset('vendor/webkul/helloworld/assets/css/app.css') }}"
    />
...
<div class="container mt-5">
    <div class="custom-row">
            ...
            <div>
                <div class="div-single-hero-slider">
                    <div class="div-hero-slider-content-1">
                        ...
                        <div class="up-to-40-off-premium-samsung-vr"> Up To 40% Off <br />Premium <br/> Samsung VR </div>
                        <div class="we-work-with-global-brand-and-have-create-an-smart-gadget-for-you-to-make-easiest-life"> We work with global brand and<br/> have create an smart <br />gadget for you to make easiest life. </div>
                        <div class="link">
        ...
        <div class="col-md-5">
            <div class="row">
                <div class="col-md-12 mb-3 smaller-col">
                    <div class="bg-secondary p-lg-4">
